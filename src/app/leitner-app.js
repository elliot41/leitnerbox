...
import { fetchAllFlashcards, getCurrentUser } from '../services/supabaseService.js';
            ...
            html`
              <aside class="sidebar">
                ...
                <nav class="side-nav">
                  ...
                  <button 
                    class="nav-button ${this.view === 'leitner' ? 'active' : ''}"
                  ...
                  html`
                    ...
                    ${this.view === 'leitner' ? 
                      html`
                        <leitner-deck
                          .flashcards=${this.flashcards}
                          @flashcard-updated=${this.handleFlashcardUpdated}
                        ></leitner-deck>
                      ` : ''
                    }
